  ...
  return (
    <Card
      ...
      <div
        className={
          plan.comingSoon
            ? 'pointer-events-none blur-[3px] opacity-50 transition-all'
            : ''
        }>
        <CardHeader className="pb-4 relative">
          ...
          {plan.badge && (
            <Badge
              className="w-fit mb-3 bg-primary text-primary-foreground font-semibold shadow-md border-0 uppercase tracking-widest px-3"
              variant="default">
              {plan.badge}
            </Badge>
          )}
