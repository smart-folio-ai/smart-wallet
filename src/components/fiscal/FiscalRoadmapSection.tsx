...
/**
 * Buckets e histórico de DARFs com números reais do ano. O aviso "em breve"
 * não é mais desta seção sozinha — `Fiscal.tsx` borra a página inteira com
 * `ComingSoonBlur` (TRA-182), então este componente só renderiza o conteúdo.
 */
export function FiscalRoadmapSection({month, monthly, year}: {month: FiscalMonth | null; monthly: FiscalMonth[]; year?: number}) {
  ...
  return (
    <div data-testid="fiscal-roadmap">
