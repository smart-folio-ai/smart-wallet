...
export type BadgeSeverity = 'warn' | 'info' | 'ok' | 'neg';
...
const BADGE_TONE: Record<BadgeSeverity, React.CSSProperties> = {
...
export function badgeStyle(sev: BadgeSeverity): React.CSSProperties {
  return {
    flexShrink: 0,
