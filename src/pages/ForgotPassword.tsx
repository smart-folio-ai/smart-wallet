    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          ...
          >
            Acontece com os melhores. Informe seu e-mail cadastrado e enviaremos as instruções de recuperação em instantes.
          </p>

          {/* Steps */}
          <div className="mt-10 space-y-4">
            {[
              {step: '01', title: 'Informe seu e-mail', desc: 'Digite o e-mail vinculado à sua conta'},
              {step: '02', title: 'Verifique sua caixa de entrada', desc: 'Enviaremos um link de recuperação seguro'},
              {step: '03', title: 'Redefina sua senha', desc: 'Crie uma nova senha e acesse o terminal'},
            ].map((item) => (
              <div
                key={item.step}
              ...
              >
                <span
                  ...
                  style={{color: '#2665fd', fontFamily: 'Manrope, sans-serif', minWidth: '1.5rem'}}
                >
                  {item.step}
                </span>
                <div>
          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="mb-8">
                ...
                <p style={{color: 'rgba(195,197,216,0.6)', fontSize: '0.9rem'}}>
                  Informe seu e-mail e enviaremos as instruções para a recuperação.
                </p>
              </div>
            ...
            <div id="forgot-password-success">
              ...
              <div className="mb-8">
                ...
                <p style={{color: 'rgba(195,197,216,0.6)', fontSize: '0.9rem', lineHeight: '1.6'}}>
              ...
              >
                <p className="text-sm" style={{color: 'rgba(195,197,216,0.7)'}}>
                  O link de recuperação expira em <strong style={{color: '#b5c4ff'}}>30 minutos</strong>. Caso não receba o e-mail, tente novamente.
                </p>
              </div>
