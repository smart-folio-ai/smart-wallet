...
const SyncAccounts = () => {
  ...
  const BrokerageNoteHelpModal = () => (
    <Dialog open={showBrokerageNoteHelp} onOpenChange={setShowBrokerageNoteHelp}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle>Por que subir nota de corretagem?</DialogTitle>
          <DialogDescription>
            A nota de corretagem melhora a precisão da sua carteira e dos cálculos fiscais.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 text-sm text-muted-foreground">
          <p>
            Quando você envia a nota, o sistema consegue identificar operações reais
            de compra e venda com mais detalhe do que uma sincronização simples de saldo.
          </p>
          <div className="space-y-2">
            <p className="font-medium text-foreground">O que melhora na prática:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>Preço médio correto por ativo e por movimentação.</li>
              <li>Quantidade atualizada com base em compras, vendas e ajustes.</li>
              <li>Base fiscal mais confiável para apuração de IR e compensação de prejuízo.</li>
              <li>Histórico auditável das operações por data, ativo e corretora.</li>
              <li>Menos risco de divergência entre carteira real e carteira no app.</li>
            </ul>
          </div>
          <div className="rounded-lg border border-border/60 p-3 bg-card/40">
            <p className="font-medium text-foreground mb-1">Segurança e uso dos dados</p>
            <p>
              O arquivo é usado para extrair informações de movimentação (ativo, quantidade, preço e data)
              e atualizar sua carteira. Não é necessário compartilhar senha da corretora para esse processo.
            </p>
          </div>
        </div>
        <DialogFooter>
          <Button onClick={() => setShowBrokerageNoteHelp(false)}>Entendi</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="rounded-lg border border-border/60 bg-card/40 p-4 space-y-2">
          <p className="text-sm text-foreground">
            {syncSuccess.syncedAssets} ativo(s) foram atualizados para a carteira{' '}
            <span className="font-semibold">{syncSuccess.providerName}</span>.
          </p>
          <p className="text-xs text-muted-foreground">
            Você já pode ver seus ativos em <span className="font-semibold">Portfólio</span>,
            selecionando a carteira da {syncSuccess.providerName}.
          </p>
        </div>
    ...
    <div className="min-h-screen p-2 md:p-6 relative overflow-hidden font-sans bg-transparent text-foreground">
      ...
      <div className="relative z-10 max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-col mb-8">
          ...
          <p className="text-sm md:text-base text-muted-foreground">
            Conecte corretoras e exchanges para centralizar seu portfólio de forma rápida e segura.
          </p>
        </div>
      ...
      {connections.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <Card className="rounded-2xl bg-card border border-border/50 shadow-xl shadow-primary/5 overflow-hidden p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-3xl font-bold font-heading text-foreground">{connections.length}</p>
          ...
          <Card className="rounded-2xl bg-card border border-border/50 shadow-xl shadow-primary/5 overflow-hidden p-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-base font-medium font-heading text-foreground">Última sincronização</p>
        ...
        <Card className="rounded-2xl bg-card border border-border/50 shadow-xl shadow-primary/5 overflow-hidden mb-8">
          <CardHeader className="border-b border-border/40">
            <div className="flex items-start justify-between gap-3">
              <div>
                <CardTitle className="font-heading tracking-tight text-foreground">Processamento assíncrono de arquivos</CardTitle>
      ...
      <Card className="rounded-2xl bg-card border border-border/50 shadow-xl shadow-primary/5 overflow-hidden mb-8">
        <CardHeader className="border-b border-border/40 mb-6 pb-6 pt-8">
          <CardTitle className="text-2xl font-heading tracking-tight text-foreground">Adicione suas contas</CardTitle>
